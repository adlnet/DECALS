...
// */
//public class AlfrescoSearchHandler2 extends SearchHandler2 {
//	
...
//
//	protected Vector<ESBPacket> pendingEdits;
//
//	/**
...
//	 */
//	protected void buildTile0(AjaxPacket searchTermPacketx, int index, String objPanel, Element td) {
//		ESBPacket searchTermPacket = (ESBPacket) searchTermPacketx;
//		Vector<String> iDs = null;
//		//TODO fix build tiles references
////		if (searchTermPacket.getSearchRecords().get(index)!=null&&((ESBPacket)searchTermPacket.getSearchRecords().get(index)).getNodeId()!=null) {
...
////			tileHandlers.add(new TileHandler(this, idPrefix, searchType, (ESBPacket) searchTermPacket.getSearchRecords().get(index)));
////		}
//	}
//
//	/**
...
//		searchType = type;
//		customQuery = null;
//		pendingEdits = new Vector<ESBPacket>();
//		t = new Timer() {
//				@Override
//				public void run() {
...
//						ap.put("terms", customQuery + " ASPECT:\"russel:metaTest\"");
//					else if (searchType.equals(ASSET_TYPE))
//						ap.put("terms", EPSSEditScreen.buildQueryString() + " ASPECT:\"russel:metaTest\"");
//					else if (searchText=="")
//						ap.put("terms", "ASPECT:\"russel:metaTest\"");
//					else
//						ap.put("terms", searchText + " ASPECT:\"russel:metaTest\"");
//					ap.put("rowLimit", 100);
//					ap.put("sort", "");
//					ap.put("page", 0);
//					
...
//						if (searchText=="")
//							ap.put("terms", "cm:name:rpf ASPECT:\"russel:metaTest\"");
//						else
//							ap.put("terms", searchText + " cm:name:rpf ASPECT:\"russel:metaTest\"");						
//					}
//					
//					if (searchType.equals(SEARCH_TYPE)) {
//						if (searchText=="")
//							ap.put("terms", "ASPECT:\"russel:metaTest\"" + util.buildSearchQueryString());
//						else
//							ap.put("terms", searchText + " ASPECT:\"russel:metaTest\"" + util.buildSearchQueryString());
//						ap.put("sort", util.buildSearchSortString());
//					}
//					
//					if (searchType.equals(COLLECTION_TYPE)) {
//						if (searchText=="")
//							ap.put("terms", "creator:" + ESBApi.username + " ASPECT:\"russel:metaTest\"" + util.buildSearchQueryString());
//						else
//							ap.put("terms", searchText + " creator:" + ESBApi.username + " ASPECT:\"russel:metaTest\"" + util.buildSearchQueryString());
//						ap.put("sort", util.buildSearchSortString());
//					}
//					
//					if (searchType.equals(FLR_TYPE)) {	
//						if (searchText=="")
//							ap.put("terms", "cm:name:rlr ASPECT:\"russel:metaTest\"" + util.buildSearchQueryString());
//						else
//							ap.put("terms", searchText + " cm:name:rlr ASPECT:\"russel:metaTest\"" + util.buildSearchQueryString());
//						ap.put("sort", util.buildSearchSortString());
//					} 
//					
...
//						ap.put("terms", "modified:[\"" + pastDate.getYear() + "-" + pastMonthPadded + "-" + pastDayPadded + "\" to \"" +  currentDate.getYear() + "-" + currentMonthPadded + "-" + currentDayPadded + "\"] ASPECT:\"russel:metaTest\"");
//						ap.put("sort", "cm:modified|false");
//					}
//					
//					ESBApi.search(ap,
